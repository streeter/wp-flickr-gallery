    ...
    var wp-flickr-gallery = function () {    
        ...
        return {
            ...
            showAsEditable: function (e, clear) {
                var id = e.get(0).id;     
                if (!clear) {
                    e.addClass('wp-flickr-gallery-editable');
                    ...
                    e.removeClass('wp-flickr-gallery-editable');
                    if (id === 'wp-flickr-gallery-photo-desc') {
                        if (nodesc !== '') {
                            e.html('&nbsp;');
                        }
            ...
            show_post_helper_block: function () {
                jQuery('#wp-flickr-gallery-post-helper-switch').hide();
            ...
            show_post_helper_block_close: function () {
                jQuery('#wp-flickr-gallery-post-helper-switch').show();
                jQuery('#wp-flickr-gallery-post-helper-block').hide();            
            },                                                
            
            post_helper_update_value: function () {
                var e = jQuery('#wp-flickr-gallery-post-helper-value');
                var t = e.html();
                ...
                var re = new RegExp('(.*id=[0-9]+,)(j|justification)?=?(l|left|r|right|c|center)?,?(.*])', 'g');
                if (f == '') {
                    t = t.replace(re, '$1$4');
                } else {
                    t = t.replace(re, '$1j=' + f + ',$4');
                }
                
                re = new RegExp('(.*(s|size)=)(sq|t|s|m|z|l|o)(.*])', 'g');       
            ...
            ajax_init: function () {
                jQuery('a','#wp-flickr-gallery').each(function (i){
            ...
            ajax: function (_link) {
                jQuery("#wp-flickr-gallery-wrapper").block('Please wait ...', { border: '1px solid #aaa', fontWeight: 'bold' });   
                jQuery("#wp-flickr-gallery").css( {backgroundColor: '#fff', opacity: '0.5' } );
                ...
                var success = function (response){    
                    ...
                    //jQuery("#wp-flickr-gallery-wrapper").unblock();
                        
                    jQuery("#wp-flickr-gallery_log").remove();            
                    var e = jQuery("#wp-flickr-gallery-wrapper");        
